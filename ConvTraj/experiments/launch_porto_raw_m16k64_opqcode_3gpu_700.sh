...
echo "[PLAN] Three Porto-only 700-epoch OPQ-code runs"
echo "[PLAN] cuda:0 baseline-extend: exact best 500 schedule, just let it run longer"
echo "[PLAN] cuda:1 slow-handoff: longer teacher and later GT takeover"
echo "[PLAN] cuda:2 realign-boost: baseline plus codebook realign and slightly stronger decoded STE"

launch_variant "porto_raw_m16k64_opqcode_frozen700_base_cuda0"      "cuda:0" "0.00" "1.00" "280" "280" "240" "0.020" "120" "40" "0.12" "0.0020" "0.00005" "600" "0"
launch_variant "porto_raw_m16k64_opqcode_frozen700_slowhandoff_cuda1" "cuda:1" "0.00" "1.00" "360" "360" "320" "0.020" "140" "50" "0.12" "0.0020" "0.00005" "620" "0"
launch_variant "porto_raw_m16k64_opqcode_frozen700_realign_cuda2"   "cuda:2" "0.00" "1.00" "320" "280" "240" "0.020" "110" "35" "0.14" "0.0015" "0.00003" "600" "1"

echo "[DONE] All three runs launched."
