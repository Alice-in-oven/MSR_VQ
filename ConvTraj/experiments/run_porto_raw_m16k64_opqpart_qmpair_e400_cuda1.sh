...
EXP_ROOT="$ROOT/exp/porto_raw_m16k64_opqpart_qmpair_e400_cuda1"
TRAIN_FLAG="porto_raw_m16k64_opqpart_qmpair_e400_cuda1"
DEVICE="cuda:1"
...
python -u train.py \
  ...
  --improved_qm_warmup_epochs 40 \
  --improved_qm_max_weight 0.05 \
  --improved_pairwise_weight 0.02 \
