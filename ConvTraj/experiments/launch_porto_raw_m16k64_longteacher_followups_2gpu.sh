...
echo "[PLAN] Two Porto-only longteacher follow-ups"
echo "[PLAN] cuda:0 teacher-stronger-longer"
echo "[PLAN] cuda:1 teacher-to-decoded handoff"

# Hypothesis A:
# Push closer to the offline OPQ structure by keeping a stronger partition teacher alive
# longer while slightly reducing early PDT pressure.
launch_variant "porto_raw_m16k64_direct_teacherplus_e400_cuda0" "cuda:0" "0.06" "0.60" "320" "30" "0.025" "0" "20" "0.15" "0.005" "0.0002" "385"

# Hypothesis B:
# Let the OPQ teacher establish a good partition early, then hand off more aggressively
# to decoded retrieval optimization with stronger STE and lower regularization.
launch_variant "porto_raw_m16k64_direct_handoff_e400_cuda1" "cuda:1" "0.10" "0.50" "220" "40" "0.020" "0" "15" "0.18" "0.003" "0.0001" "-1"
